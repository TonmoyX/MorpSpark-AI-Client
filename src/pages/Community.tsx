    ...
    <div className="px-4 md:px-16 lg:px-24 xl:px-32">
      {loading ? (
          ...
          <div className="flex flex-wrap gap-3.5">
            {projects.map((project) => (
              <Link
                ...
                target="_blank"
                key={project.id}
                className="w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg p-4 overflow-hidden shadow-md group  hover:border-indigo-600 transition-all duration-300"
              >
        ...
        <div className="flex flex-col items-center justify-center h-[80vh] gap-6">
          ...
          <button
            onClick={() => navigate("/")}
            className="flex items-center gap-2 bg-linear-to-r from-[#CB52D4] to-indigo-600 rounded-md px-4 py-2"
          >
