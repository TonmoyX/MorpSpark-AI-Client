...
const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(({project, isGeneratign, device = 'desktop', showEditorPanel = true, ref}) => {
    ...
    const handleUpdate = (updates : any) =>{
        if(iframeRef.current?.contentWindow){
            iframeRef.current?.contentWindow.postMessage({type : 'UPDATE_ELEMENT',
                payload : updates
            }, '*')
        }
    }
